 ...
 * Every renderer/page operation is serialized through one dedicated thread.
 */
class PdfRendererEngine(file: File) : PdfEngine {
    ...
    private val dispatcher =
        Executors.newSingleThreadExecutor { runnable ->
            Thread(runnable, "PdfRendererEngine").apply {
                isDaemon = true
            }
    ...
    override suspend fun pageSize(page: Int): PointF =
    ...
    override suspend fun render(
        ...
        withContext(dispatcher) {
            ...
            renderer.openPage(page).use { p ->
                ...
                val ratio =
                    p.height.toFloat() / p.width.toFloat()
